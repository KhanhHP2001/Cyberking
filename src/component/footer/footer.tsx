...
const Footer: React.FC = () => {
  return (
    <footer className="bg-[#181927] text-white w-full pt-10">
      <div className="container mx-auto flex justify-between flex-wrap p-6">
        ...
        <div className="flex flex-col space-y-2 p-4">
          <h3 className="font-bold text-[12px] md:text-[18px] xl:text-[22px] pb-2">
            Thông tin liên hệ
          </h3>
          <p className="flex items-center space-x-2">
            <FontAwesomeIcon icon={faPhoneVolume} width={15} />
            <span className="text-[14px] md:text-[10px] xl:text-[20px] font-semibold">
        ...
        <div className="flex flex-col space-y-2 p-4">
          ...
          <a
            ...
            className="text-[14px] md:text-[10px] xl:text-[20px] font-semibold text-[#D1D1D4] hover:text-white"
          >
            Chính sách bảo mật
          </a>
          <a
      ...
      <div className="text-center font-medium py-4 text-[#9BA0A0] text-[12px] md:text-[14px] xl:text-[18px]">
