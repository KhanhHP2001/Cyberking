...
const Header = () => {
  return (
    <section className="relative w-screen xl:min-h-[900px] lg:min-h-[600px] min-h-[200px] flex items-center justify-center overflow-hidden bg-transparent ">
      <video
      ...
      {/* <div className=" xl:ml-12 hidden lg:ml-9 xl:mt-36 lg:mt-24 w-full h-full md:flex items-center z-10">
        <a
